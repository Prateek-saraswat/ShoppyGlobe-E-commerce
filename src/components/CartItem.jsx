...
const CartItem = ({ item }) => {
  ...
  return (
    <div className="flex items-center gap-4 bg-white border border-gray-100 rounded-2xl p-4 shadow-sm">
      ...
      <div className="w-20 h-20 flex-shrink-0 bg-gray-50 rounded-xl flex items-center justify-center p-2 border border-gray-100">
        <img
          src={item.thumbnail}
          alt={item.title}
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[11px] text-gray-400 capitalize mb-0.5">{item.category}</p>
      ...
      <div className="text-right flex-shrink-0 hidden sm:block">
        ...
        <p className="text-sm font-extrabold text-gray-900">${itemTotal}</p>
      </div>
